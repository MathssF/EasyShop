...
const products: ShopProduct[] = [
  ...
  new ShopProduct(30, 5, 5, 'Teclado Mecânico', 'Teclado gamer RGB', 2),
  new ShopProduct(20, 0, 0, 'Mouse Sem Fio', 'Mouse ergonômico', 1),
  new ShopProduct(15, 8, 10, 'Fone Bluetooth', 'Fone de ouvido com redução de ruído', 3),
  new ShopProduct(100, 0, 0, 'Monitor 27"', 'Monitor Full HD', 8),
  new ShopProduct(80, 6, 15, 'Cadeira Gamer', 'Conforto e ergonomia', 10),
  ...
  new ShopProduct(5, 9, 0, 'Mouse Pad', 'Superfície antiderrapante', 0)
];
